...
urlpatterns = [
      ...
      path('provider/<int:pk>/ingredients/edit/', views.ProviderIngredientsEditView.as_view(), name="provider_ingredients_edit"),
      ...
      path('receta/<int:pk>/steps/update/', views.receta_steps_update, name="receta_steps_update"),
